...
def encrypt(blk, something_key):
    blk = np.copy(blk)
    blk[0:2] = combination_magic(blk[0:2], blk[2:4], something_key[0:2]) #01
    blk[2:4] = combination_magic(blk[2:4], blk[0:2], something_key[2:4]) #01

    blk[0:2] = combination_magic(blk[0:2], blk[2:4], something_key[4:6]) #23
    blk[2:4] = combination_magic(blk[2:4], blk[0:2], something_key[6:8]) #23

    blk[0:2] = combination_magic(blk[0:2], blk[2:4], something_key[8:10]) #01
    blk[2:4] = combination_magic(blk[2:4], blk[0:2], something_key[10:12]) #01
